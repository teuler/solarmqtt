...
'
' To grab the program:
'   tftp 192.168.178.73 get "SolarMQTT_v11.bas"
' ----------------------------------------------------------------------------
Option Explicit
Option Base 0
Option Escape
...
Sub UpdateDisplay
  ...
  For i=0 To N_DAYS -1 '20230909
 'For i=1 To N_DAYS -1 '20230908
    x1 = x +i*(dx+4)
    ...
    If i < log.nWeek Then
      ...
      Else
        ...
        enrgy = log.energy(i+2) -log.energy(i+1) '20230908
        s$ = log.wdays$(i+2)
      EndIf
